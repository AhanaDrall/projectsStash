  ...
  .then((data) => {
    ...
    data.forEach((userTable) => {
      ...
      li += `<tr>
            ...
            <td>${userTable.city}</td>
          <td>  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 
            <div  class="btn-group me-2" role="group" aria-label="Second group">
              <button type="button" class="btn btn-success" onclick="updateUser(${userTable.id})" data-toggle="modal" data-target="#myModal" >Update</button>
              </div>
              <div class="btn-group" role="group" aria-label="Third group">
                <button type="button" onclick="deleteUser(${userTable.id})" class="btn btn-danger" >Delete</button></td>
              </tr>`;
      });
